...
def RNNMain():
    ...
    for lerr in ler:
        for dr in drp:
            ...
            model = RNN_train(x_train_dataset,y_train_dataset,lerr,dr)
            ...
            write_to_file(model_path,sensitivity,specifity,precision,accuracy,f1_score,mcc,lerr,dr)
            print(lerr,dr)
...
def write_to_file(model_path,sensitivity,specifity,precision,accuracy,f1_score,mcc,lerr,dr):
