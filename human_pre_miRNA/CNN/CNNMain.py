...
def CNNMain():
    ...
    write_to_file(model_path,sensitivity,specifity,precision,accuracy,f1_score,mcc)
...
def write_to_file(model_path,sensitivity,specifity,precision,accuracy,f1_score,mcc):
